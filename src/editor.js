function gcrExtEditorUpdateAnswersList() {
    ...
    for (var i = 0; i < __gcrExtAnswers.length; i++) {
        var li = gcrExtEditorCreateItem(i + 1, __gcrExtAnswers[i].name, __gcrExtAnswers[i].description);
        li.answerId = i;
        list.appendChild(li);
    }
}
